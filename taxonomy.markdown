...
<p>To apply the taxonomy in practice, use DIST's <a href="/methodologies/">methodology map</a> and <a href="/schema/">schema</a> to produce and share impact estimates.</p>
</div>
...
<div class="my-6">
  ...
  <div class="prose mt-6">
    ...
    <p>Use the buttons below to toggle between the available impact dimensions the DIST community have worked on.</p>
  </div>
</div>
...
{% tabs log %}
  ...
  <div class="my-8 info-box">
    ...
    <p>Use this in conjunction with the carbon <a href="/methodologies/">methodology map</a> and <a href="/schema/">schema</a> to estimate and share your digital estate's carbon emission information.</p>
  </div>
